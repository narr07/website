...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt-site-config:init' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'nuxt:global-components' | 'nuxt-seo:fallback-titles' | 'nuxt-schema-org:defaults' | '@nuxt/icon' | 'nuxt:checkIfLayoutUsed' | 'nuxt-schema-org:init' | 'nuxt-seo:defaults'
  }
}
