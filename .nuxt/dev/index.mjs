...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getQuery as getQuery$1, getCookie, getRequestHost, getRequestProtocol, getRequestHeaders, setHeader, getHeader, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText, H3Error } from 'file:///Users/user/web/website/node_modules/h3/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/user/web/website/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file:///Users/user/web/website/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file:///Users/user/web/website/node_modules/unstorage/drivers/lru-cache.mjs';
import { html as html$2 } from 'file:///Users/user/web/website/node_modules/satori-html/dist/index.js';
import { consola, createConsola } from 'file:///Users/user/web/website/node_modules/consola/dist/index.mjs';
import { createGenerator } from 'file:///Users/user/web/website/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///Users/user/web/website/node_modules/@unocss/preset-wind/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, withLeadingSlash, withoutTrailingSlash, isRelative, hasProtocol, withHttps, withoutProtocol, withBase, joinRelativeURL, withoutLeadingSlash, parsePath } from 'file:///Users/user/web/website/node_modules/ufo/dist/index.mjs';
import sizeOf from 'file:///Users/user/web/website/node_modules/image-size/dist/index.js';
import { execa } from 'file:///Users/user/web/website/node_modules/execa/index.js';
import playwrightCore from 'file:///Users/user/web/website/node_modules/playwright-core/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/user/web/website/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, parse as parse$1, uneval } from 'file:///Users/user/web/website/node_modules/devalue/index.js';
import destr, { destr as destr$1 } from 'file:///Users/user/web/website/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Users/user/web/website/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/user/web/website/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/user/web/website/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin, createHeadCore } from 'file:///Users/user/web/website/node_modules/unhead/dist/index.mjs';
import { isVNode, toValue, version, unref } from 'file:///Users/user/web/website/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file:///Users/user/web/website/node_modules/@unhead/shared/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/user/web/website/node_modules/unstorage/drivers/fs.mjs';
import { klona } from 'file:///Users/user/web/website/node_modules/klona/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///Users/user/web/website/node_modules/scule/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/user/web/website/node_modules/radix3/dist/index.mjs';
import { $fetch as $fetch$1, createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/user/web/website/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/user/web/website/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/user/web/website/node_modules/hookable/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file:///Users/user/web/website/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/user/web/website/node_modules/errx/dist/index.js';
import { extname, basename, resolve as resolve$1, isAbsolute } from 'file:///Users/user/web/website/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///Users/user/web/website/node_modules/unified/index.js';
import { toString } from 'file:///Users/user/web/website/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///Users/user/web/website/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///Users/user/web/website/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Users/user/web/website/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/user/web/website/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/user/web/website/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///Users/user/web/website/node_modules/micromark-util-sanitize-uri/dev/index.js';
import slugify from 'file:///Users/user/web/website/node_modules/slugify/slugify.js';
import remarkParse from 'file:///Users/user/web/website/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///Users/user/web/website/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///Users/user/web/website/node_modules/remark-mdc/dist/index.mjs';
import remarkEmoji from 'file:///Users/user/web/website/node_modules/remark-emoji/index.js';
import remarkGFM from 'file:///Users/user/web/website/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///Users/user/web/website/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///Users/user/web/website/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///Users/user/web/website/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///Users/user/web/website/node_modules/rehype-raw/index.js';
import { detab } from 'file:///Users/user/web/website/node_modules/detab/index.js';
import { toString as toString$1 } from 'file:///Users/user/web/website/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///Users/user/web/website/node_modules/github-slugger/index.js';
import devalue from 'file:///Users/user/web/website/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getIcons } from 'file:///Users/user/web/website/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/user/web/website/.nuxt/nuxt-icon-server-bundle.mjs';
import Fuse from 'file:///Users/user/web/website/node_modules/fuse.js/dist/fuse.common.js';
import { readFile } from 'node:fs/promises';
import { diffLines } from 'file:///Users/user/web/website/node_modules/diff/lib/index.mjs';
import MagicString from 'file:///Users/user/web/website/node_modules/magic-string/dist/magic-string.es.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/user/web/website/node_modules/ipx/dist/index.mjs';
import { Resvg } from 'file:///Users/user/web/website/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///Users/user/web/website/node_modules/satori/dist/index.js';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "nuxt-link-checker": {
      ...
      "rootDir": "/Users/user/web/website",
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/Users/user/web/website/.nuxt/cache/nuxt-og-image@3.0.0-rc.65/_fonts"},{"baseName":"server","dir":"/Users/user/web/website/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/user/web/website/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/user/web/website/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/user/web/website","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/user/web/website/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/user/web/website/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/user/web/website/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/user/web/website/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _5eAGriw4Ov = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/user/web/website";
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/user/web/website/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _dwheFnMDoE = defineNitroPlugin(async (nitro) => {
...
const _2h0uhnGW7A = defineNitroPlugin(async (nitroApp) => {
...
const _XqBluIx7Hw = defineNitroPlugin(async (nitroApp) => {
...
const _j2dFWWSl9F = defineNitroPlugin((nitroApp) => {
...
const _mtX8uhnEZ2 = defineNitroPlugin((nitroApp) => {
...
const _iL7Lfy0vtV = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _TJssDDyWe4 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _UwX3sW = defineCachedEventHandler(async (ctx) => {
...
const _wAa8n4 = defineEventHandler(async (e) => {
...
const _4HDJRu = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _9X3hko = defineEventHandler(async (e) => {
...
const _tH5FGm = defineEventHandler(async (e) => {
...
const _04N2Vm = defineEventHandler(async (e) => {
  const content = [];
  try {
...
const _jwkMFk = defineEventHandler(async (e) => {
...
const _reLEeg = defineEventHandler(async (e) => {
...
const _GEkV5b = defineEventHandler(async (e) => {
...
const _AfEnNl = defineEventHandler(async (e) => {
...
const _ZVSY93 = defineEventHandler(async (e) => {
...
const _v9TmJt = defineEventHandler(async (e) => {
...
const _POubAD = defineEventHandler(async (e) => {
...
const _h449cW = defineEventHandler(async (e) => {
  const path = parseURL(e.path).pathname;
  if (fileMapping[path]) {
...
const _D92qpM = defineEventHandler(async (e) => {
...
const _omHxVi = defineCachedEventHandler(async (e) => {
  const runtimeConfig = useRuntimeConfig().public["nuxt-link-checker"] || {};
  const linkDb = [
    ...pagePaths
  ];
...
const _JEGv7Q = defineEventHandler(async (e) => {
  return {
...
const _CVNXrN = defineEventHandler(async (event) => {
...
const _F1C9vF = defineEventHandler(async (event) => {
...
const _KjvqOI = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _yKOyU4 = lazyEventHandler(() => {
...
const _lazy_4sgoJB = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_0jN1Hr = () => Promise.resolve().then(function () { return font$1; });
const _lazy_YtXJdx = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_QhOLmm = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_4sgoJB, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _UwX3sW, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _wAa8n4, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _4HDJRu, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _9X3hko, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _tH5FGm, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/nuxt-content.json', handler: _04N2Vm, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug.json', handler: _jwkMFk, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _reLEeg, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: _GEkV5b, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _AfEnNl, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _ZVSY93, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _v9TmJt, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_0jN1Hr, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_YtXJdx, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_QhOLmm, lazy: true, middleware: false, method: undefined },
  { route: '/__schema-org__/debug.json', handler: _POubAD, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _h449cW, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/inspect', handler: _D92qpM, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/links', handler: _omHxVi, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/debug.json', handler: _JEGv7Q, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _CVNXrN, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _CVNXrN, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _CVNXrN, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _F1C9vF, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _KjvqOI, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _KjvqOI, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _KjvqOI, lazy: false, middleware: false, method: "get" },
  { route: '/_ipx/**', handler: _yKOyU4, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_4sgoJB, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_4sgoJB, lazy: true, middleware: false, method: undefined }
];
...
async function useSharp() {
  sharpInstance.instance = sharpInstance.instance || await import('file:///Users/user/web/website/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
  return sharpInstance.instance;
}
async function useCssInline() {
  cssInlineInstance.instance = cssInlineInstance.instance || await import('file:///Users/user/web/website/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
...
const getClientManifest = () => import('file:///Users/user/web/website/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/user/web/website/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const componentNames = [{"hash":"eQ6ZSzmuSi","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/Users/user/web/website/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/BrandedLogo.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"urK4vBHedV","pascalName":"Frame","kebabName":"frame","path":"/Users/user/web/website/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Frame.vue","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"25HYRU2CwN","pascalName":"Nuxt","kebabName":"nuxt","path":"/Users/user/web/website/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Nuxt.vue","category":"community","credits":"NuxtLabs <https://nuxtlabs.com/>"},{"hash":"t4cC294xbl","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/Users/user/web/website/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/NuxtSeo.vue","category":"community","credits":"Nuxt SEO <https://nuxtseo.com/>"},{"hash":"Ti15ewGcfK","pascalName":"Pergel","kebabName":"pergel","path":"/Users/user/web/website/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Pergel.vue","category":"community","credits":"Pergel <https://nuxtlabs.com/>"},{"hash":"g66oUAfYIc","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/Users/user/web/website/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/SimpleBlog.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"PdTiW3yQ0N","pascalName":"UnJs","kebabName":"un-js","path":"/Users/user/web/website/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/UnJs.vue","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"dxElbCCT8d","pascalName":"Wave","kebabName":"wave","path":"/Users/user/web/website/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Wave.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"GANho8xkgv","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/Users/user/web/website/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/WithEmoji.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"}];
